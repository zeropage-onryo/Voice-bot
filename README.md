...
An automated "patient caller" voice bot. It places real phone calls to a test line, plays a realistic patient persona pursuing a specific scenario (scheduling, refills, edge cases), and captures the recording + transcript for bug analysis.
